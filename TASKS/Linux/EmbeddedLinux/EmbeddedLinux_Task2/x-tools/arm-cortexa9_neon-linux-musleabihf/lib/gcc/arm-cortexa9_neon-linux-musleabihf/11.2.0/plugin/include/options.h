...
enum opt_code
{
  ...
  OPT_mbionic = 1689,                        /* -mbionic */
  OPT_mbranch_cost_ = 1690,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1691,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1692,     /* -mcaller-super-interworking */
  OPT_mcmse = 1693,                          /* -mcmse */
  OPT_mcpu_ = 1694,                          /* -mcpu= */
  OPT_mfdpic = 1695,                         /* -mfdpic */
  ...
  OPT_mglibc = 1702,                         /* -mglibc */
  /* OPT_mhard_float = 1703, */              /* -mhard-float */
  OPT_mlibarch_ = 1704,                      /* -mlibarch= */
  OPT_mlittle_endian = 1705,                 /* -mlittle-endian */
  OPT_mlong_calls = 1706,                    /* -mlong-calls */
  OPT_mmusl = 1707,                          /* -mmusl */
  OPT_mneon_for_64bits = 1708,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1709,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1710,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1711,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1712,               /* -mprint-tune-info */
  OPT_mpure_code = 1713,                     /* -mpure-code */
  OPT_mrestrict_it = 1714,                   /* -mrestrict-it */
  OPT_msched_prolog = 1715,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1716,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1717,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1718, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1719,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1720,                         /* -mthumb */
  OPT_mthumb_interwork = 1721,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1722,                  /* -mtls-dialect= */
  OPT_mtp_ = 1723,                           /* -mtp= */
  OPT_mtpcs_frame = 1724,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1725,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1726,                         /* -mtune= */
  OPT_muclibc = 1727,                        /* -muclibc */
  OPT_munaligned_access = 1728,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1729,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1730,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1731,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1732,              /* -mword-relocations */
  OPT_n = 1733,                              /* -n */
  ...
  OPT_pie = 1753,                            /* -pie */
  OPT_pipe = 1754,                           /* -pipe */
  OPT_posix = 1755,                          /* -posix */
  OPT_print_file_name_ = 1756,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1757,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1758,          /* -print-multi-directory */
  OPT_print_multi_lib = 1759,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1760,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1761,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1762,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1763,               /* -print-prog-name= */
  OPT_print_search_dirs = 1764,              /* -print-search-dirs */
  OPT_print_sysroot = 1765,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1766,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1767,                    /* -print-value */
  OPT_profile = 1768,                        /* -profile */
  OPT_pthread = 1769,                        /* -pthread */
  OPT_quiet = 1770,                          /* -quiet */
  OPT_r = 1771,                              /* -r */
  OPT_rdynamic = 1772,                       /* -rdynamic */
  OPT_remap = 1773,                          /* -remap */
  OPT_reverse_sort = 1774,                   /* -reverse-sort */
  OPT_s = 1775,                              /* -s */
  OPT_save_temps = 1776,                     /* -save-temps */
  OPT_save_temps_ = 1777,                    /* -save-temps= */
  OPT_shared = 1778,                         /* -shared */
  OPT_shared_libgcc = 1779,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1780,               /* -shared-libphobos */
  OPT_size_sort = 1781,                      /* -size-sort */
  /* OPT_specs = 1782, */                    /* -specs */
  OPT_specs_ = 1783,                         /* -specs= */
  OPT_static = 1784,                         /* -static */
  OPT_static_libasan = 1785,                 /* -static-libasan */
  OPT_static_libgcc = 1786,                  /* -static-libgcc */
  OPT_static_libgfortran = 1787,             /* -static-libgfortran */
  OPT_static_libgo = 1788,                   /* -static-libgo */
  OPT_static_libhwasan = 1789,               /* -static-libhwasan */
  OPT_static_liblsan = 1790,                 /* -static-liblsan */
  OPT_static_libmpx = 1791,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1792,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1793,               /* -static-libphobos */
  OPT_static_libstdc__ = 1794,               /* -static-libstdc++ */
  OPT_static_libtsan = 1795,                 /* -static-libtsan */
  OPT_static_libubsan = 1796,                /* -static-libubsan */
  OPT_static_pie = 1797,                     /* -static-pie */
  /* OPT_std_c__03 = 1798, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1799, */                /* -std=c++0x */
  OPT_std_c__11 = 1800,                      /* -std=c++11 */
  OPT_std_c__14 = 1801,                      /* -std=c++14 */
  OPT_std_c__17 = 1802,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1803, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1804, */                /* -std=c++1z */
  OPT_std_c__20 = 1805,                      /* -std=c++20 */
  OPT_std_c__23 = 1806,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1807, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1808, */                /* -std=c++2b */
  OPT_std_c__98 = 1809,                      /* -std=c++98 */
  OPT_std_c11 = 1810,                        /* -std=c11 */
  OPT_std_c17 = 1811,                        /* -std=c17 */
  /* OPT_std_c18 = 1812, */                  /* -std=c18 */
  /* OPT_std_c1x = 1813, */                  /* -std=c1x */
  OPT_std_c2x = 1814,                        /* -std=c2x */
  /* OPT_std_c89 = 1815, */                  /* -std=c89 */
  OPT_std_c90 = 1816,                        /* -std=c90 */
  OPT_std_c99 = 1817,                        /* -std=c99 */
  /* OPT_std_c9x = 1818, */                  /* -std=c9x */
  OPT_std_f2003 = 1819,                      /* -std=f2003 */
  OPT_std_f2008 = 1820,                      /* -std=f2008 */
  OPT_std_f2008ts = 1821,                    /* -std=f2008ts */
  OPT_std_f2018 = 1822,                      /* -std=f2018 */
  OPT_std_f95 = 1823,                        /* -std=f95 */
  OPT_std_gnu = 1824,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1825, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1826, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1827,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1828,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1829,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1830, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1831, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1832,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1833,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1834, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1835, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1836,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1837,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1838,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1839, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1840, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1841,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1842, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1843,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1844,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1845, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1846, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1847,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1848, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1849, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1850, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1851, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1852, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1853,                     /* -std=legacy */
  OPT_stdlib_ = 1854,                        /* -stdlib= */
  OPT_symbol_ = 1855,                        /* -symbol= */
  OPT_symbolic = 1856,                       /* -symbolic */
  OPT_t = 1857,                              /* -t */
  OPT_time = 1858,                           /* -time */
  OPT_time_ = 1859,                          /* -time= */
  OPT_tno_android_cc = 1860,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1861,                 /* -tno-android-ld */
